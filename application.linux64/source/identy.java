...
class gui {
  ...
  private int strokeColor = color(0xff660000); // color(225, 225, 225);
  private int fillColor = color(0xffdddddd); // color(245, 245, 245);
...
public class MotionListener implements MotionEventListener {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "identy" };
    if (passedArgs != null) {
